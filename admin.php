...
<body>
    <div class="wrapper">
        ...
        <div class="container content"  id="wizards-panel">
            <div class="panel panel-default">
            </div>
        </div>

        <div class="container content"  id="new-wizard-panel">
            <div class="panel panel-default">
        ...
        <div class="container-fluid" >
            <div id="subjects-panel" class="panel panel-default content col-md-8 col-xs-12">
                <div class="panel-heading">
            ...
            <div class="panel panel-default content col-md-8 col-xs-12" id="new-subject-panel">
                <div class="panel-heading">
            ...
            <div class="panel panel-default content col-md-8 col-xs-12" id="new-calculation-panel">
                <div class="panel-heading">
            ...
            <div class="panel panel-default content col-md-8 col-xs-12" id="new-analysis-panel">
                <div class="panel-heading">
            ...
            <div id="new-analysis-dictionary-tab" class="col-md-4 col-xs-12">
                <ul class="nav nav-tabs">
