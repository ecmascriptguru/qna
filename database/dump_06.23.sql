...
insert  into `qna_analyses`(`id`,`wizard_id`,`name`,`condition`,`result`) values (3,2,'First one','{\"subjects\":[{\"id\":\"3\",\"question\":\"how old are you?\",\"answer\":\"1\"}],\"calculations\":[{\"id\":\"1\",\"name\":\"Test\",\"factors\":\"\"}]}','aaa bb cccc d'),(4,2,'Real one?','{\"subjects\":[{\"id\":3,\"answer\":\"1\",\"question\":\"how old are you?\"}],\"calculations\":[{\"id\":\"1\",\"name\":\"Test\",\"operator\":\"+\"}]}','aa');
...
insert  into `qna_calculations`(`id`,`wizard_id`,`name`,`operator`,`factors`) values (1,2,'Test','+','[{\"coeff\":\"1\",\"id\":\"3\"},{\"coeff\":\"1\",\"id\":\"2\"}]');
...
insert  into `qna_subjects`(`id`,`question`,`wizard_id`,`type_id`,`answers`) values (2,'Is that true?',2,1,'[{\"caption\":\"\",\"value\":\"\",\"weight\":\"0\",\"next\":\"\"},{\"caption\":\"\",\"value\":\"\",\"weight\":\"0\",\"next\":\"\"}]'),(3,'how old are you?',2,2,'[{\"caption\":\"\",\"value\":1,\"weight\":100,\"next\":null}]');
